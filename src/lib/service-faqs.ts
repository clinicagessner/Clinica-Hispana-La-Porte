...
export const SERVICE_FAQS: Record<string, ServiceFaq[]> = {
  ...
  "tiroides": [
    ...
    },
    {
      ...
      answer: "No. Puedes desayunar. Si ya tomas levotiroxina, hazte la extracción antes de la dosis de ese día para que el resultado sea confiable.",
      questionEn: "Do I need to fast for a thyroid test?",
      answerEn: "No. You can have breakfast. If you already take levothyroxine, have your blood drawn before that day's dose so the result is reliable.",
    },
    {
    ...
    },
    {
      ...
      answer: "Además del laboratorio, hacemos un ultrasonido de tiroides para medir la glándula y describir el nódulo. La mayoría son benignos; según sus características te indicamos vigilancia o biopsia con el especialista.",
      questionEn: "I have a lump in my neck. What do you do?",
      answerEn: "Besides lab work, we do a thyroid ultrasound to measure the gland and describe the nodule. Most are benign; based on its features we recommend monitoring or a biopsy with the specialist.",
    },
    {
      question: "¿La tiroides puede causar que no baje de peso o que se me caiga el cabello?",
      answer: "Sí. El hipotiroidismo provoca aumento de peso, caída de cabello, cansancio, piel seca y frío. Una TSH sencilla lo confirma o lo descarta.",
      questionEn: "Can my thyroid keep me from losing weight or cause hair loss?",
      answerEn: "Yes. Hypothyroidism causes weight gain, hair loss, fatigue, dry skin and cold intolerance. A simple TSH confirms or rules it out.",
    },
    {
  ...
  "salud-hombre": [
    ...
    },
    {
      ...
      answer: "Entre 8 y 10 de la mañana, cuando el nivel es más alto, y con 8 horas de ayuno si aprovechas para hacerte glucosa y colesterol. Si sale baja, se repite otro día para confirmar.",
      questionEn: "What time should I take the testosterone test?",
      answerEn: "Between 8 and 10 in the morning, when the level is highest, and after 8 hours of fasting if you are also having glucose and cholesterol done. If it is low, it is repeated another day to confirm.",
    },
    {
      question: "¿Desde qué edad debo hacerme el PSA?",
      answer: "Se recomienda hablar de la prueba desde los 50 años, o desde los 45 si tu padre o hermano tuvieron cáncer de próstata. Evita eyacular, andar en bicicleta y ejercicio intenso 48 horas antes.",
      questionEn: "At what age should I start getting a PSA test?",
      answerEn: "It is recommended to discuss the test from age 50, or from 45 if your father or brother had prostate cancer. Avoid ejaculation, cycling and intense exercise for 48 hours before.",
    },
    {
    ...
    },
    {
      ...
      answer: "Revisa tu testosterona $79, perfil hormonal para hombres $200 y chequeo general completo $99 con sangre, A1C, orina y consulta. El PSA se cotiza por separado; te damos el precio antes de la extracción.",
      questionEn: "How much do men's health exams cost?",
      answerEn: "Check your testosterone $79, hormone panel for men $200 and complete general checkup $99 with blood work, A1C, urine test and consultation. PSA is priced separately; we give you the price before the draw.",
    },
    {
  ...
  "infecciones-urinarias": [
    ...
    },
    {
      ...
      answer: "Lávate las manos, limpia la zona genital, deja salir el primer chorro y recoge el chorro medio en el frasco estéril que te damos. Si puedes, aguanta la orina 1 o 2 horas antes para que la muestra sea más concentrada.",
      questionEn: "How should I collect the urine sample?",
      answerEn: "Wash your hands, clean the genital area, let the first stream pass and collect the midstream in the sterile cup we give you. If you can, hold your urine for 1 or 2 hours beforehand so the sample is more concentrated.",
    },
    {
    ...
    },
    {
      ...
      answer: "Normalmente en 24 a 48 horas de iniciar el antibiótico. Toma mucha agua y termina todo el tratamiento. Si en 3 días no mejoras, regresa para revisar el urocultivo y ajustar.",
      questionEn: "How soon does the burning go away?",
      answerEn: "Usually within 24 to 48 hours of starting the antibiotic. Drink plenty of water and finish the full course. If you are not better in 3 days, come back so we can review the culture and adjust.",
    },
    {
      question: "¿Cuándo debo ir a urgencias en lugar de la clínica?",
      answer: "Si tienes fiebre alta con escalofríos, vómito que no te deja tomar líquidos, dolor intenso en la espalda o estás embarazada con fiebre. La infección puede haber llegado a los riñones y requerir tratamiento intravenoso.",
      questionEn: "When should I go to the ER instead of the clinic?",
      answerEn: "If you have high fever with chills, vomiting that keeps you from drinking fluids, severe back pain, or you are pregnant with a fever. The infection may have reached the kidneys and require IV treatment.",
    },
    {
      question: "¿Necesito cita o seguro para el examen de orina?",
      answer: "No. Ven sin cita de lunes a sábado de 9 AM a 9 PM o domingo de 9 AM a 7 PM. No necesitas seguro; la consulta y el examen de orina tienen precio fijo.",
      questionEn: "Do I need an appointment or insurance for a urine test?",
      answerEn: "No. Walk in Monday to Saturday from 9 AM to 9 PM or Sunday from 9 AM to 7 PM. No insurance needed; the visit and urine test have a flat price.",
    },
  ],
  "examen-heces": [
    {
  ...
  "examen-alcohol-drogas": [
    {
      ...
      answer: "Sí. Si tu empleador pide ambos, hacemos la prueba de drogas y el examen físico pre-empleo en la misma visita, y también el examen DOT para choferes comerciales.",
      questionEn: "Can you do the drug test and the physical the same day?",
      answerEn: "Yes. If your employer requires both, we do the drug test and the pre-employment physical during the same visit, and the DOT exam for commercial drivers as well.",
    },
    {
      question: "¿En cuánto tiempo tengo el resultado?",
      answer: "La prueba rápida da resultado en 10 a 15 minutos. Si sale positiva o tu empresa exige confirmación certificada, la muestra va al laboratorio y el resultado tarda 2 a 4 días.",
      questionEn: "How soon do I get the result?",
      answerEn: "The rapid test gives a result in 10 to 15 minutes. If it is positive or your company requires certified confirmation, the sample goes to the lab and the result takes 2 to 4 days.",
    },
    {
      question: "¿Qué drogas detecta la prueba?",
      answer: "El panel de 5 detecta marihuana, cocaína, anfetaminas y metanfetaminas, opiáceos y PCP. El de 10 agrega benzodiacepinas, barbitúricos, metadona y otros opioides. Tu empleador indica cuál necesita.",
      questionEn: "Which drugs does the test detect?",
      answerEn: "The 5-panel detects marijuana, cocaine, amphetamines and methamphetamines, opiates and PCP. The 10-panel adds benzodiazepines, barbiturates, methadone and other opioids. Your employer indicates which one is needed.",
    },
    {
      question: "Tomo medicamentos con receta, ¿pueden dar positivo?",
      answer: "Algunos sí, como analgésicos opioides o ansiolíticos. Trae tus recetas: quedan documentadas y la confirmación de laboratorio distingue el medicamento recetado del consumo de drogas.",
      questionEn: "I take prescription medications. Can they cause a positive?",
      answerEn: "Some can, such as opioid pain relievers or anti-anxiety drugs. Bring your prescriptions: they are documented and lab confirmation distinguishes a prescribed medication from drug use.",
    },
    {
      question: "¿Entregan documentación para el trabajo?",
      answer: "Sí. Te entregamos el resultado por escrito con fecha y firma, llenamos el formulario de tu empleador si lo traes y, cuando aplica, la cadena de custodia. El resultado solo se comparte con quien tú autorices.",
      questionEn: "Do you provide documentation for work?",
      answerEn: "Yes. We give you the written result with date and signature, complete your employer's form if you bring it and, when applicable, the chain of custody. The result is shared only with whom you authorize.",
    },
    {
      question: "¿Necesito cita o seguro para la prueba de drogas?",
      answer: "No. Ven sin cita de lunes a sábado de 9 AM a 9 PM o domingo de 9 AM a 7 PM, con identificación con foto. No necesitas seguro; el precio es fijo según el panel.",
      questionEn: "Do I need an appointment or insurance for a drug test?",
      answerEn: "No. Walk in Monday to Saturday from 9 AM to 9 PM or Sunday from 9 AM to 7 PM with a photo ID. No insurance needed; the price is flat depending on the panel.",
    },
  ],
  "electrocardiograma": [
    {
  ...
  "examen-dot": [
    ...
    },
    {
      ...
      answer: "Hasta 2 años sin condiciones. Con presión entre 140/90 y 159/99 es por 1 año; entre 160/100 y 179/109, por 3 meses; con diabetes en insulina, hasta 1 año.",
      questionEn: "How long is the certificate valid?",
      answerEn: "Up to 2 years with no conditions. With blood pressure 140/90 to 159/99 it is 1 year; 160/100 to 179/109, 3 months; with insulin-treated diabetes, up to 1 year.",
    },
    {
      question: "¿Qué pasa si mi presión sale alta el día del examen?",
      answer: "Según el nivel, recibes un certificado de 1 año o de 3 meses, o queda pendiente si es de 180/110 o más. Podemos iniciar tratamiento ese mismo día para que regreses a recertificar pronto. Evita café y cigarro dos horas antes.",
      questionEn: "What if my blood pressure is high on exam day?",
      answerEn: "Depending on the level, you get a 1-year or 3-month certificate, or it stays pending if it is 180/110 or higher. We can start treatment that same day so you can come back to recertify soon. Avoid coffee and cigarettes for two hours beforehand.",
    },
    {
      question: "¿El examen DOT incluye prueba de drogas?",
      answer: "No. El examen de orina del DOT revisa glucosa, proteínas y sangre. Si tu empresa exige prueba de drogas y alcohol, la hacemos en la misma visita como servicio aparte.",
      questionEn: "Does the DOT exam include a drug test?",
      answerEn: "No. The DOT urinalysis checks glucose, protein and blood. If your company requires drug and alcohol testing, we do it during the same visit as a separate service.",
    },
    {
      question: "¿Necesito cita para el examen DOT y cuánto cuesta?",
      answer: "No necesitas cita ni seguro. Atendemos de lunes a sábado de 9 AM a 9 PM y domingo de 9 AM a 7 PM; el examen tiene precio fijo que te confirmamos por teléfono.",
      questionEn: "Do I need an appointment for the DOT exam and how much is it?",
      answerEn: "No appointment or insurance needed. We are open Monday to Saturday from 9 AM to 9 PM and Sunday from 9 AM to 7 PM; the exam has a flat price we confirm by phone.",
    },
  ],
  "examenes-inmigracion": [
    ...
    },
    {
      ...
      answer: "Depende de tu edad: Tdap, sarampión-rubéola-paperas, varicela, hepatitis B, neumococo e influenza en temporada, entre otras. Trae tu cartilla de vacunación: las que ya tienes se registran y no se repiten.",
      questionEn: "Which vaccines will I need?",
      answerEn: "It depends on your age: Tdap, measles-mumps-rubella, varicella, hepatitis B, pneumococcal and influenza in season, among others. Bring your vaccination card: the ones you already have are recorded and not repeated.",
    },
    {
      question: "Tuve la vacuna BCG o una prueba de TB positiva, ¿qué pasa?",
      answer: "El I-693 usa la prueba de sangre IGRA, que no se altera por la BCG. Si sale positiva, se requiere una radiografía de tórax que coordinamos; con radiografía normal el trámite continúa.",
      questionEn: "I had the BCG vaccine or a positive TB test. What happens?",
      answerEn: "The I-693 uses the IGRA blood test, which is not affected by BCG. If it is positive, a chest X-ray is required, which we coordinate; with a normal X-ray the process continues.",
    },
    {
      question: "¿Cuánto cuesta el examen de inmigración?",
      answer: "Es un precio fijo que incluye el examen, el llenado del I-693 y las pruebas de laboratorio requeridas; las vacunas que te falten se cotizan aparte. Te damos el total antes de empezar. El seguro médico no lo cubre.",
      questionEn: "How much does the immigration exam cost?",
      answerEn: "It is a flat price that includes the exam, completion of the I-693 and the required lab tests; any missing vaccines are priced separately. We give you the total before starting. Health insurance does not cover it.",
    },
    {
      question: "¿Puedo abrir el sobre para revisar el formulario?",
      answer: "No. USCIS rechaza el sobre si está abierto. Te entregamos una copia del formulario aparte para que revises tus datos y la guardes en tu expediente.",
      questionEn: "Can I open the envelope to check the form?",
      answerEn: "No. USCIS rejects the envelope if it is opened. We give you a separate copy of the form so you can check your information and keep it in your records.",
    },
  ],
  "vacunas": [
    {
