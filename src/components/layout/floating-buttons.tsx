...
export function FloatingButtons() {
  ...
  return (
    // Todo el grupo (Volver arriba, Maps, Llamar, WhatsApp) aparece junto al
    // salir del hero. `invisible` bloquea clics; los hijos son pointer-events-auto.
    <div
      className={cn(
    ...
    >
      ...
      <button
        ...
        className="pointer-events-auto flex h-11 w-11 items-center justify-center rounded-full border border-blue-light bg-white text-blue-dark shadow-md transition-colors hover:bg-sky-bg"
      >
